...
('全力斬り', 5, 180, '命中率低/威力180%', 0),
('ヒール', 10, 0, 'HP回復', 0),
('ファイア', 15, 130, '炎ダメージ130%', 0),
('ブリザード', 20, 100, '威力100%+氷結30%', 0),
('ポイズン', 8, 40, '威力40%+毒100%', 0),
('スタン撃ち', 12, 80, '威力80%+気絶50%', 0),
('薙ぎ払い', 10, 50, '全体に威力50%', 1),
('アースクエイク', 40, 90, '全体に威力90%', 1),
('ドレイン', 15, 80, '威力80%+吸収', 0),
('メテオ', 30, 220, '超魔法220%', 0),
('隠れ身', 20, 0, 'MP20消費/1ターン隠密', 0);
